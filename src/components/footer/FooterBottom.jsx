...
const FooterBottom = () => {
  return (
    <div className="mt-12 lg:mt-[100px] mb-12 lg:mb-20">
      <div className='flex justify-between flex-wrap font-["Montserrat"] text-[#303030] mb-12 lg:mb-20 gap-6 '>
          ...
          <ul className="flex flex-col  gap-3 flex-wrap font-normal text-sm lg:text-base leading-6 ">
            {footerContact.map((item) => (
              <li key={item.label} className="relative pl-0 lg:pl-8">
                <Link
                  className="hover:text-[#FF624C] flex items-center max-[855px]:justify-center lg:justify-start gap-2"
                  to={item.to}
                >
                  <span
          ...
          <div>
            ...
            <ul className="text-[#303030] font-normal text-sm lg:text-base leading-6 flex flex-col gap-3">
              {footerLinks.map((item) => (
                <li key={item.label}>
                  <Link className="hover:text-[#FF624C]" to={item.to}>
                    {item.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="flex flex-col gap-6 text-center lg:text-left grow">
          ...
          <div>
            ...
            <ul className="text-[#303030] font-normal text-sm lg:text-base leading-6 justify-center flex md:flex-col gap-3">
