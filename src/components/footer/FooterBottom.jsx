...
import { footerLinks, footerSupports, footerCategories, footerSocials } from "../../productDetailsArrays";
      ...
      <div className='flex flex-col lg:flex-row justify-between font-["Montserrat"] text-[#303030] mb-12 lg:mb-20 gap-8 lg:gap-0'>
        <div className="flex flex-col justify-between text-center lg:text-left">
          ...
          <ul className="font-normal text-sm lg:text-base leading-6 flex flex-col gap-3">
            ...
            <li className="relative pl-0 lg:pl-8">
              <Link className="hover:text-[#FF624C] flex items-center justify-center lg:justify-start gap-2" to={"mailto:information@eshop.com"}>
                <span className="text-[#646464] lg:absolute lg:top-1/2 lg:-translate-1/2 lg:left-2">
                  <EnvelopeFooter />
                </span>
            ...
            <li className="relative pl-0 lg:pl-8">
              <Link className="hover:text-[#FF624C] flex items-center justify-center lg:justify-start gap-2" to={"https://maps.app.goo.gl/GLKtcy2x3Lo6XxJq5"}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:flex gap-8 lg:gap-24">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-24 lg:flex">
            <div className="text-center lg:text-left">
              <h4 className='font-semibold leading-[30px] font-["Poppins"] mb-4 lg:mb-6 text-lg lg:text-xl'>Links</h4>
              <ul className="text-[#303030] font-normal text-sm lg:text-base leading-6 flex flex-col gap-3">
                {footerLinks.map((item) => (
                  <li key={item.label}>
                    <Link className="hover:text-[#FF624C]" to={item.to}>{item.label}</Link>
                  </li>
                ))}
              </ul>
            </div>
            <div className="text-center lg:text-left">
              <h4 className='font-semibold leading-[30px] font-["Poppins"] mb-4 lg:mb-6 text-lg lg:text-xl'>Supports</h4>
              <ul className="text-[#303030] font-normal text-sm lg:text-base leading-6 flex flex-col gap-3">
