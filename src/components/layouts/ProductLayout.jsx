      ...
      {v2 || (
        <div className="h-[496px] p-6 pb-11 flex-1 bg-white border border-transparent rounded-[10px] hover:border-[#C3C3C3] transition-all duration-300 ease-in-out text-[#303030] group block cursor-pointer ">
          <div className="relative ">
            ...
            <div className="flex absolute justify-center gap-[18px] left-1/2 -translate-x-1/2 -bottom-10 group-hover:bottom-[6px] opacity-0 group-hover:opacity-100 transition-transform duration-300 ease-in-out  ">
              <Link
                to={"#"}
