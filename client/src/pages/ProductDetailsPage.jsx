...
const ProductDetailsPage = () => {
  ...
  if (loading)
    return <Container><ProductDetailsSkeleton /></Container>;

  if (!product)
    return (
      <Container>
        <div className="py-20 text-center font-poppins text-xl">Product not found.</div>
      </Container>
    );
    ...
    <Container>
      <div className="mt-8 lg:mt-16">
        <div className="flex flex-wrap gap-2 lg:gap-4 items-center text-black font-montserrat text-sm lg:text-base leading-5 lg:leading-6">
          ...
          <span className="hidden sm:inline capitalize">{product.category}</span>
